...
class Customize(bpy.types.Operator):
    ...
    def customize_workspace_pie(self, context):
        ...
        for piedir in ['left', 'right', 'bottom', 'top', 'top_left', 'top_right', 'bottom_left', 'bottom_right']:
            ...
            elif piedir == 'bottom_left':
                setattr(p, f'pie_workspace_{piedir}_name', 'GeoNodes')
                setattr(p, f'pie_workspace_{piedir}_text', 'Geo Nodes')
                setattr(p, f'pie_workspace_{piedir}_icon', 'GEOMETRY_NODES')
